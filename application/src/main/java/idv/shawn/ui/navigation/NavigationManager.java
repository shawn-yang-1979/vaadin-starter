package idv.shawn.ui.navigation;
...
import idv.shawn.ui.views.admin.product.ProductAdminView;
...
public class NavigationManager extends SpringNavigator {
	...
	public void navigateToDefaultView() {
		...
		navigateTo(SecurityUtils.isCurrentUserInRole(Role.ADMIN) ? ProductAdminView.class : StorefrontView.class);
	}
